            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start group">
                ...
                <div>
                  ...
                  <a href="mailto:sstm476@gmail.com" className="text-white font-semibold hover:text-purple-300">
                    sstm476@gmail.com
                  </a>
                </div>
              </li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-center md:text-left mb-4 md:mb-0">
              <p className="flex items-center justify-center md:justify-start">
                Made with <FaHeart className="text-red-500 mx-2 animate-pulse-slow" /> by School Team
              </p>
              <p className="text-sm mt-1">
                &copy; {currentYear} School. All rights reserved.
              </p>
            </div>
